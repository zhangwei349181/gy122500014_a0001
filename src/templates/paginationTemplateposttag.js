    ...
    <div class="container">
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center mb-0">
                {{#if showPrev}}
                <li class="page-item">
                    <a class="page-link rounded-0" href="/posttag/{{categoryId}}-{{prevPage}}">
                ...
                <li class="page-item {{#if isActive}}active{{/if}}">
                    <a class="page-link rounded-0" href="/posttag/{{../categoryId}}-{{page}}">
                        {{page}}
                    </a>
                </li>
                {{/each}}
                ...
                {{#if showNext}}
                <li class="page-item">
                    <a class="page-link rounded-0" href="/posttag/{{categoryId}}-{{nextPage}}">
